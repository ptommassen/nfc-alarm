...
public class AlarmSetter extends Activity {
	...
	private void turnAlarmOn(int alarmHour, int alarmMin) {
		...
		PendingIntent sender = PendingIntent.getBroadcast(AlarmSetter.this, 0,
				alarmIntent, 0);
		...
		Toast.makeText(this,
				"Alarm Set For " + calendarHourStr + ":" + calendarMinStr,
				Toast.LENGTH_LONG).show(); // Save
											// settings
											// Enabled,
											// Alarm
											// Hour,
	...
	private void turnAlarmoff() {
		...
		Toast.makeText(AlarmSetter.this, "Alarm Disabled", Toast.LENGTH_LONG)
				.show();
	...
	public class AlarmEnableListener implements ToggleButton.OnClickListener {
		@Override
		public void onClick(View v) { // Read State of UI components and call
										// SetAlarm routine
